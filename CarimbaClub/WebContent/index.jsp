...
<body>
	<div class="text-center" id="inicio">
		<div
				...
				<div class="inner" id="es5">
					...
					<nav class="nav nav-masthead justify-content-center">
						<a class="nav-link active"
							href="${pageContext.request.contextPath}/Service?pagina=home">Home</a>
						<a class="nav-link"
							href="${pageContext.request.contextPath}/Service?pagina=cadastro">Cadastrar-se</a>
						<a class="nav-link"
							href="${pageContext.request.contextPath}/Service?pagina=login">Fazer
							Login</a>
					</nav>
				</div>
			</header>
			...
			<p class="lead" style="font-size:20px;">Nosso principal intuito é fazer o agendamento
				para seus jogos de carimbas de forma mais organizada e intuitiva
				para você!!</p>
			<p class="lead">
				<a href="${pageContext.request.contextPath}/Service?pagina=cadastro"
					class="btn btn-lg btn-secondary" id="es5"
		...
		<div class="row featurette">
			<div class="col-md-7">
				<h2 class="featurette-heading">
					Gostou? <span class="text-muted">Que tal?</span>
				</h2>
				<p class="lead">Infelizmente o carimba não é muito reconhecido
					aqui no Brasil.Assim resolvemos criar esse site especialmente para
					você viciadinho em carimba,dessa forma você e seus jogadores
					saberão exatamente o dia do seu jogo!</p>
			</div>
			<div class="col-md-5">
	...
	<footer class="page-footer font-small unique-color-dark pt-4"
		style="background-color:#f85c70;" id="es5">
		<div class="container" >
			<ul class="list-unstyled list-inline text-center py-2" id="es5"
				style="margin-bottom: 5%">
				<li class="list-inline-item">
					<h5 class="mb-1" style="color: #ffe8fe !important; margin-top: 12%">Não
						perca tempo!</h5>
				</li>
			...
			<h5 class="text-uppercase"
				style="margin-top: -3%; color: #ffd6ea; text-align: center;">Contatos</h5>
		...
		<div class="footer-copyright text-center py-3" id="fu" style="background-color:#DC143C;">
			© 2020 Copyright: <a
				href="${pageContext.request.contextPath}/Service?pagina=home">
				CarimbaClubs</a>
		</div>
